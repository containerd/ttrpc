...
type ExampleService interface {
	...
	Method2(context.Context, *Method1Request) (*emptypb.Empty, error)
}

func RegisterExampleService(srv *ttrpc.Server, svc ExampleService) {
	srv.RegisterService("ttrpc.example.v1.Example", &ttrpc.ServiceDesc{
...
func (c *exampleClient) Method2(ctx context.Context, req *Method1Request) (*emptypb.Empty, error) {
