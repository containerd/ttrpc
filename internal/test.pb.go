...
func (x *EchoPayload) Reset() {
	*x = EchoPayload{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internal_test_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*EchoPayload) Descriptor() ([]byte, []int) {
	return file_internal_test_proto_rawDescGZIP(), []int{1}
}
...
var file_internal_test_proto_rawDesc = []byte{
	...
	,
...
var file_internal_test_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
func file_internal_test_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internal_test_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
