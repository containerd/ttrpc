// This module contains external build tools used by this repository.
// Keeping them in a separate module avoids adding their dependencies to
// the main module's go.mod while still making them available through the
// workspace (see ../go.work).
module github.com/containerd/ttrpc/tools

go 1.25.6

// External tools only. In-tree tools are declared in the main module.
tool github.com/bufbuild/buf/cmd/buf

// Version of buf to use.
require github.com/bufbuild/buf v1.69.0 // indirect
